...
[![pweb1.png](https://i.postimg.cc/kG14QVH0/pweb1.png)](https://postimg.cc/bSnp8vpg)
...
[![pweb2.png](https://i.postimg.cc/L5X489sN/pweb2.png)](https://postimg.cc/hzkRCqTd)
- Ejercicio 03: Escribir una página que muestre cuántos días faltan para el día de Arequipa!
[![pweb3.png](https://i.postimg.cc/FHcrRn95/pweb3.png)](https://postimg.cc/SnSF1d2D)
...
[![pwb4.png](https://i.postimg.cc/cC4Ct7F7/pwb4.png)](https://postimg.cc/BLk4dF9t)
...
## link https://flipgrid.com/3a103f26
...
- Revisar esta discusión en stackoverflow - https://stackoverflow.com/questions/4852017/how-to-initialize-an-arrays-length-in-javascript
    ...
    Habria que estar atentos a estas cosas al momento de programar desde luego estas cosas siempre pasan loq ue se debe hacer es buscar informacion 
    que este corroborada 
    - ¿Se puede modificar la solución usando map? ¿Cómo?
    
    No estoy totalmente seguro pero usar map parece mas seguro
